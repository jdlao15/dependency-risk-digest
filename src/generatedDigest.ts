...
export const generatedAt = "2026-06-26T15:31:11.688Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-26T15:31:11.688Z"
  },
  {
    "week": "Week 25, 2026",
...
export const releases: ReleaseItem[] = [
  ...
  },
  {
    ...
    "affectedAudience": "Developer tooling, type checking, and code-quality gates.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: 3.8.5.",
    "githubReleaseTitle": "3.8.5",
    "githubReleaseUrl": "https://github.com/prettier/prettier/releases/tag/3.8.5",
    "githubReleaseTag": "3.8.5",
    "githubReleasePublishedAt": "2026-06-26T13:00:46Z",
    "releaseNotesExcerpt": "Fix Flow variance annotation print (#19022 by @marcoww6) Changelog",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/prettier/3.8.5",
    "sourceLinks": [
      {
        "label": "npm",
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/prettier/prettier/releases/tag/3.8.5"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend projects that import this package directly or receive it through transitive dependencies.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: 22.0.3.",
    "githubReleaseTitle": "22.0.3",
    "githubReleaseUrl": "https://github.com/angular/angular/releases/tag/v22.0.3",
    "githubReleaseTag": "v22.0.3",
    "githubReleasePublishedAt": "2026-06-25T15:10:33Z",
    "releaseNotesExcerpt": "compiler | Commit | Description | | -- | -- | | | account for NgModule dependencies in JIT-compiled partial declarations | | | remove unused import breaking CI in 22.0.x | compiler-cli | Commit | Description | | -- | -- | | | report diagnostic instead of crashing on malformed hos",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/angular-core/22.0.3",
    "sourceLinks": [
      {
        "label": "npm",
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/angular/angular/releases/tag/v22.0.3"
      }
    ]
  },
  {
...
export const packageRoutes = {
  ...
  "angular-core": {
    ...
    "latestReleaseRoute": "/package/angular-core/22.0.3",
    "areaSlug": "core-frameworks",
    "areaLabel": "Frameworks and Core UI"
  },
  "solid-js": {
  ...
  "prettier": {
    ...
    "latestReleaseRoute": "/package/prettier/3.8.5",
    "areaSlug": "typescript-quality",
    "areaLabel": "TypeScript and Code Quality"
  },
...
export const seoRoutes: Record<string, SeoRoute> = {
  ...
  "/package/eslint/10.5.0": {
    ...
    "title": "eslint 10.5.0 npm minor version update",
    "description": "eslint 10.5.0 frontend npm update risk: Minor version release detected with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes..."
  },
  ...
  "/package/prettier/3.8.5": {
    "path": "/package/prettier/3.8.5",
    "title": "prettier 3.8.5 npm patch version update",
    "description": "prettier 3.8.5 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/vue/3.5.39": {
  ...
  "/package/angular-core/22.0.3": {
    "path": "/package/angular-core/22.0.3",
    "title": "@angular/core 22.0.3 npm patch version update",
    "description": "@angular/core 22.0.3 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/astro/7.0.3": {
