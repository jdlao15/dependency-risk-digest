...
export const generatedAt = "2026-06-18T16:44:09.655Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-18T16:44:09.655Z"
  },
  {
    "week": "Week 24, 2026",
...
export const seoRoutes: Record<string, SeoRoute> = {
  "/weekly": {
    ...
    "description": "Week 25, 2026 frontend npm dependency-risk digest: 36 risky updates, 11 breaking changes, 4 security-relevant releases, OSV/CVE checks, release notes, and recommended actions from 82 tracked React, JavaScript, and frontend packages."
  },
  "/risk/security": {
    "path": "/risk/security",
  ...
  "/weekly/2026-w25": {
    ...
    "description": "Jun 15 - Jun 21 archive for frontend npm dependency risk: 36 risky updates, 11 breaking changes, 4 security-relevant releases, OSV/CVE checks, release notes, and recommended actions from 82 tracked packages."
  },
  "/weekly/2026-w24": {
  ...
  "/package/astro/6.4.8": {
    ...
    "title": "astro 6.4.8 breaking update",
    "description": "astro 6.4.8 frontend npm update: Major version release detected. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/react-router-dom/7.18.0": {
    "path": "/package/react-router-dom/7.18.0",
    "title": "react-router-dom 7.18.0 breaking update",
    "description": "react-router-dom 7.18.0 frontend npm update: Major version release detected. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  ...
  "/package/lucide-react/1.21.0": {
    ...
    "title": "lucide-react 1.21.0 review update",
    "description": "lucide-react 1.21.0 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/pnpm/11.8.0": {
    "path": "/package/pnpm/11.8.0",
    "title": "pnpm 11.8.0 review update",
    "description": "pnpm 11.8.0 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/angular-core/22.0.2": {
    "path": "/package/angular-core/22.0.2",
    "title": "@angular/core 22.0.2 review update",
    "description": "@angular/core 22.0.2 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/storybook-react/10.4.6": {
    "path": "/package/storybook-react/10.4.6",
    "title": "@storybook/react 10.4.6 review update",
    "description": "@storybook/react 10.4.6 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/storybook/10.4.6": {
    "path": "/package/storybook/10.4.6",
    "title": "storybook 10.4.6 review update",
    "description": "storybook 10.4.6 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  ...
  "/package/babel-preset-env/8.0.2": {
    ...
    "title": "@babel/preset-env 8.0.2 low impact update",
    "description": "@babel/preset-env 8.0.2 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/babel-core/8.0.1": {
    "path": "/package/babel-core/8.0.1",
    "title": "@babel/core 8.0.1 low impact update",
    "description": "@babel/core 8.0.1 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/babel-preset-react/8.0.1": {
    "path": "/package/babel-preset-react/8.0.1",
    "title": "@babel/preset-react 8.0.1 low impact update",
    "description": "@babel/preset-react 8.0.1 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/happy-dom/20.10.6": {
    "path": "/package/happy-dom/20.10.6",
    "title": "happy-dom 20.10.6 low impact update",
    "description": "happy-dom 20.10.6 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/graphql/17.0.1": {
    "path": "/package/graphql/17.0.1",
    "title": "graphql 17.0.1 low impact update",
    "description": "graphql 17.0.1 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/typescript-eslint-parser/8.61.1": {
    "path": "/package/typescript-eslint-parser/8.61.1",
    "title": "@typescript-eslint/parser 8.61.1 low impact update",
    "description": "@typescript-eslint/parser 8.61.1 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/typescript-eslint-eslint-plugin/8.61.1": {
    "path": "/package/typescript-eslint-eslint-plugin/8.61.1",
    "title": "@typescript-eslint/eslint-plugin 8.61.1 low impact update",
    "description": "@typescript-eslint/eslint-plugin 8.61.1 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  ...
  "/package/radix-ui-react-dialog/1.1.17": {
    ...
    "title": "@radix-ui/react-dialog 1.1.17 low impact update",
    "description": "@radix-ui/react-dialog 1.1.17 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/radix-ui-react-popover/1.1.17": {
    "path": "/package/radix-ui-react-popover/1.1.17",
    "title": "@radix-ui/react-popover 1.1.17 low impact update",
    "description": "@radix-ui/react-popover 1.1.17 frontend npm update: Patch release with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/less/4.6.6": {
