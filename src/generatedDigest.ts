...
export const generatedAt = "2026-06-22T16:31:32.639Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-22T16:31:32.639Z"
  },
  {
    "week": "Week 25, 2026",
...
export const seoRoutes: Record<string, SeoRoute> = {
  ...
  "/package/swr/2.4.1": {
    ...
    "title": "swr 2.4.1 npm low impact update",
    "description": "swr 2.4.1 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
