...
export const generatedAt = "2026-06-27T14:56:33.225Z";
...
export const releases: ReleaseItem[] = [
  {
    ...
    "recommendedAction": "Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: 3.9.0.",
    "githubReleaseTitle": "3.9.0",
    "githubReleaseUrl": "https://github.com/prettier/prettier/releases/tag/3.9.0",
    "githubReleaseTag": "3.9.0",
    "githubReleasePublishedAt": "2026-06-27T10:28:04Z",
    "releaseNotesExcerpt": "diff Prettier 3.9: Major parser upgrades and Formatting improvements",
    ...
    "sourceLinks": [
      ...
      },
      {
        ...
        "href": "https://github.com/prettier/prettier/releases/tag/3.9.0"
      }
    ]
  },
  {
  ...
  {
    "id": "tanstack-react-query-5-101-1",
    ...
    "affectedAudience": "React applications, component libraries, and frontend teams using React release workflows.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: @tanstack/vue-query@5.101.1.",
    "githubReleaseTitle": "@tanstack/vue-query@5.101.1",
    "githubReleaseUrl": "https://github.com/TanStack/query/releases/tag/%40tanstack/vue-query%405.101.1",
    "githubReleaseTag": "@tanstack/vue-query@5.101.1",
    "githubReleasePublishedAt": "2026-06-23T10:01:19Z",
    "releaseNotesExcerpt": "Patch Changes Updated dependencies \\[9eff92e]: - @tanstack/query-core@5.101.1",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/tanstack-react-query/5.101.1",
    "sourceLinks": [
      {
        "label": "npm",
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/TanStack/query/releases/tag/%40tanstack/vue-query%405.101.1"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "publishedAgo": "published 268 days ago",
    "isRecent": false,
    "risk": "low",
    "category": "Patch version",
    "osv": "No OSV match",
...
export const packageRoutes = {
  ...
  "prettier": {
    ...
    "latestReleaseRoute": "/package/prettier/3.9.0",
    "areaSlug": "typescript-quality",
    "areaLabel": "TypeScript and Code Quality"
  },
  ...
  "tanstack-react-query": {
    ...
    "latestReleaseRoute": "/package/tanstack-react-query/5.101.1",
    "areaSlug": "routing-state-data",
    "areaLabel": "Routing, State, and Data"
  },
  "zustand": {
...
export const seoRoutes: Record<string, SeoRoute> = {
  "/weekly": {
    ...
    "description": "Week 26, 2026 digest for frontend npm security updates, breaking package releases, OSV/CVE signals, React dependency risk, and recommended update actions from 82 tracked packages."
  },
  "/risk/security": {
    "path": "/risk/security",
  ...
  "/package/prettier/3.9.0": {
    "path": "/package/prettier/3.9.0",
    "title": "prettier 3.9.0 npm minor version update",
    "description": "prettier 3.9.0 frontend npm update risk: Minor version release detected with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release..."
  },
  ...
  "/package/tanstack-react-query/5.101.1": {
    "path": "/package/tanstack-react-query/5.101.1",
    "title": "@tanstack/react-query 5.101.1 npm patch version update",
    "description": "@tanstack/react-query 5.101.1 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  ...
  "/package/postcss/8.5.15": {
    ...
    "title": "postcss 8.5.15 npm patch version update",
    "description": "postcss 8.5.15 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
