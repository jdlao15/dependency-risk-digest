...
export const generatedAt = "2026-06-22T15:51:01.661Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-22T15:51:01.661Z"
  },
  {
    "week": "Week 25, 2026",
...
export const seoRoutes: Record<string, SeoRoute> = {
  ...
  "/package/ws/8.21.0": {
    ...
    "title": "ws 8.21.0 npm security update",
    "description": "ws 8.21.0 frontend npm update risk: GitHub release notes mention security or vulnerability fixes. OSV: No OSV match. CVE: No CVE match. Recommended action: Update recommended. Review the GitHub release notes and prioritize..."
  },
  ...
  "/package/swc-core/1.15.41": {
    ...
    "title": "@swc/core 1.15.41 npm low impact update",
    "description": "@swc/core 1.15.41 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
