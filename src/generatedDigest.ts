...
export const seoRoutes: Record<string, SeoRoute> = {
  "/weekly": {
    ...
    "description": "Week 23, 2026 frontend npm dependency-risk digest: 24 risky updates, 6 breaking changes, 3 security-relevant releases, OSV/CVE checks, release notes, and recommended actions from 50 tracked React, JavaScript, and frontend packages."
  },
  "/risk/security": {
    "path": "/risk/security",
  ...
  "/weekly/2026-w23": {
    ...
    "description": "Jun 1 - Jun 7 archive for frontend npm dependency risk: 24 risky updates, 6 breaking changes, 3 security-relevant releases, OSV/CVE checks, release notes, and recommended actions from 50 tracked packages."
  },
  "/package/react": {
    "path": "/package/react",
  ...
  "/package/pnpm/11.5.0": {
    ...
    "description": "pnpm 11.5.0 frontend npm update: Major version release detected. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  ...
  "/package/react/19.2.6": {
    ...
    "description": "react 19.2.6 frontend npm update: Major version release detected. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/react-dom/19.2.6": {
    "path": "/package/react-dom/19.2.6",
    "title": "react-dom 19.2.6 breaking update",
    "description": "react-dom 19.2.6 frontend npm update: Major version release detected. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  ...
  "/package/storybook-react/10.4.1": {
    ...
    "description": "@storybook/react 10.4.1 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/storybook/10.4.1": {
    "path": "/package/storybook/10.4.1",
    "title": "storybook 10.4.1 review update",
    "description": "storybook 10.4.1 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  ...
  "/package/next/16.2.6": {
    ...
    "description": "next 16.2.6 frontend npm update: Minor version release detected with no OSV match. OSV result: No OSV match. CVE signal: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/zod/4.4.3": {
