...
export const generatedAt = "2026-06-25T15:47:10.404Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-25T15:47:10.404Z"
  },
  {
    "week": "Week 25, 2026",
...
export const releases: ReleaseItem[] = [
  {
    ...
    "recommendedAction": "Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: v5.108.0.",
    "githubReleaseTitle": "v5.108.0",
    "githubReleaseUrl": "https://github.com/webpack/webpack/releases/tag/v5.108.0",
    "githubReleaseTag": "v5.108.0",
    "githubReleasePublishedAt": "2026-06-25T09:40:34Z",
    "releaseNotesExcerpt": "Minor Changes Treat top-level await and import.meta as ES module markers, matching Node.js syntax detection so no explicit module type is needed. (by @alexander-akait in #21218) Add a bun target that emits ESM and externalizes bun:* and node.js built-in modules. (by @alexander-ak",
    ...
    "sourceLinks": [
      ...
      },
      {
        ...
        "href": "https://github.com/webpack/webpack/releases/tag/v5.108.0"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend projects that import this package directly or receive it through transitive dependencies.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: astro@7.0.2.",
    "githubReleaseTitle": "astro@7.0.2",
    "githubReleaseUrl": "https://github.com/withastro/astro/releases/tag/astro%407.0.2",
    "githubReleaseTag": "astro@7.0.2",
    "githubReleasePublishedAt": "2026-06-23T16:22:56Z",
    "releaseNotesExcerpt": "Patch Changes Updated dependencies \\[3b5e994]: - @astrojs/markdown-satteri@0.3.2",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/astro/7.0.2",
    "sourceLinks": [
      {
        "label": "npm",
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/withastro/astro/releases/tag/astro%407.0.2"
      }
    ]
  },
  {
...
export const packageRoutes = {
  ...
  "astro": {
    ...
    "description": "Content-focused web framework",
    "route": "/package/astro",
    "latestReleaseRoute": "/package/astro/7.0.2",
    "areaSlug": "core-frameworks",
    "areaLabel": "Frameworks and Core UI"
  },
  "nuxt": {
  ...
  "webpack": {
    ...
    "latestReleaseRoute": "/package/webpack/5.108.0",
    "areaSlug": "build-tooling",
    "areaLabel": "Build Tooling"
  },
  "rollup": {
...
export const seoRoutes: Record<string, SeoRoute> = {
  ...
  "/package/webpack/5.108.0": {
    "path": "/package/webpack/5.108.0",
    "title": "webpack 5.108.0 npm minor version update",
    "description": "webpack 5.108.0 frontend npm update risk: Minor version release detected with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release..."
  },
  ...
  "/package/astro/7.0.2": {
    "path": "/package/astro/7.0.2",
    "title": "astro 7.0.2 npm patch version update",
    "description": "astro 7.0.2 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  ...
  "/package/prettier/3.8.4": {
    ...
    "title": "prettier 3.8.4 npm patch version update",
    "description": "prettier 3.8.4 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
  "/package/nuxt/4.4.8": {
