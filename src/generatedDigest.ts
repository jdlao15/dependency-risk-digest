...
export const generatedAt = "2026-09-07T18:16:22.210Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "topSignals": [
      ...
      },
      {
        ...
        "route": "/package/lucide-react/1.42.0",
        "risk": "review",
        "newVersion": "1.42.0",
    ...
    "generatedAt": "2026-09-07T18:16:22.210Z"
  },
  {
    "week": "Week 36, 2026",
...
export const releases: ReleaseItem[] = [
  ...
  },
  {
    ...
    "recommendedAction": "Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: Version 1.42.0.",
    "githubReleaseTitle": "Version 1.42.0",
    "githubReleaseUrl": "https://github.com/lucide-icons/lucide/releases/tag/1.42.0",
    "githubReleaseTag": "1.42.0",
    "githubReleasePublishedAt": "2026-09-07T10:06:35Z",
    "releaseNotesExcerpt": "What's Changed feat(docs): added better contribution guide by @karsa-mistmere in https://github.com/lucide-icons/lucide/pull/4746 fix(site): fix HomeHeroIconsCard.data.ts by @karsa-mistmere in https://github.com/lucide-icons/lucide/pull/4805 fix(icons): deprecated swiss franc ico",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/lucide-react/1.42.0",
    "sourceLinks": [
      {
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/lucide-icons/lucide/releases/tag/1.42.0"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend projects that import this package directly or receive it through transitive dependencies.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: pnpm 12.3.4.",
    "githubReleaseTitle": "pnpm 12.3.4",
    "githubReleaseUrl": "https://github.com/pnpm/pnpm/releases/tag/v12.3.4",
    "githubReleaseTag": "v12.3.4",
    "githubReleasePublishedAt": "2026-09-04T14:23:18Z",
    "releaseNotesExcerpt": "Patch Changes Sped up dependency resolution in large workspaces #14352. pnpm 12 now accepts the boolean settings as command-line flags on every command that takes them in pnpm 11, for example pnpm install --unsafe-perm, pnpm add foo --offline, and pnpm install --dangerously-allow",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/pnpm/12.3.4",
    "sourceLinks": [
      {
        "label": "npm",
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/pnpm/pnpm/releases/tag/v12.3.4"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "publishedAgo": "published 351 days ago",
    "isRecent": false,
    "risk": "low",
    "category": "Patch version",
    "osv": "No OSV match",
...
export const packageRoutes = {
  ...
  "lucide-react": {
    ...
    "latestReleaseRoute": "/package/lucide-react/1.42.0",
    "areaSlug": "css-ui",
    "areaLabel": "CSS and UI Libraries"
  },
  "mui-material": {
  ...
  "pnpm": {
    ...
    "description": "Package manager",
    "route": "/package/pnpm",
    "latestReleaseRoute": "/package/pnpm/12.3.4",
    "areaSlug": "utilities-runtime",
    "areaLabel": "JavaScript Utilities and Runtime"
  },
  "uuid": {
...
export const seoRoutes: Record<string, SeoRoute> = {
  "/weekly": {
    ...
    "description": "Week 37, 2026 digest for frontend npm security updates, breaking package releases, OSV/CVE signals, React dependency risk, and recommended update actions from 82 tracked packages."
  },
  "/risk/security": {
    "path": "/risk/security",
  ...
  "/weekly/2026-w37": {
    ...
    "description": "Sep 7 - Sep 13 archive for frontend npm dependency risk: 25 risky updates, 3 breaking releases, 0 security updates, OSV/CVE checks, and recommended actions."
  },
  "/weekly/2026-w36": {
  ...
  "/package/lucide-react/1.42.0": {
    "path": "/package/lucide-react/1.42.0",
    "title": "lucide-react 1.42.0 npm minor version update",
    "description": "lucide-react 1.42.0 frontend npm update risk: Minor version release detected with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release..."
  },
  ...
  "/package/pnpm/12.3.4": {
    "path": "/package/pnpm/12.3.4",
    "title": "pnpm 12.3.4 npm patch version update",
    "description": "pnpm 12.3.4 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
