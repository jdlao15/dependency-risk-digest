...
export const generatedAt = "2026-07-26T14:44:42.373Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "topSignals": [
      ...
      },
      {
        ...
        "route": "/package/lucide-react/1.27.0",
        "risk": "review",
        "newVersion": "1.27.0",
        "reason": "Minor version release detected with no OSV match.",
        "recommendedAction": "Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review.",
    ...
    "generatedAt": "2026-07-26T14:44:42.373Z"
  },
  {
    "week": "Week 30, 2026",
    "dateRange": "Jul 20 - Jul 26",
...
export const releases: ReleaseItem[] = [
  ...
  },
  {
    ...
    "affectedAudience": "React applications, component libraries, and frontend teams using React release workflows.",
    "recommendedAction": "Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: Version 1.27.0.",
    "githubReleaseTitle": "Version 1.27.0",
    "githubReleaseUrl": "https://github.com/lucide-icons/lucide/releases/tag/1.27.0",
    "githubReleaseTag": "1.27.0",
    "githubReleasePublishedAt": "2026-07-25T21:00:42Z",
    "releaseNotesExcerpt": "What's Changed feat(icons): removed brand names from tags & revised brand stopwords by @karsa-mistmere in https://github.com/lucide-icons/lucide/pull/4575 fix(docs): Fix site build by @ericfennis in https://github.com/lucide-icons/lucide/pull/4582 fix(icons): optimised square-sci",
    "releaseNotesStatus": "Matched GitHub release by exact npm version tag.",
    "route": "/package/lucide-react/1.27.0",
    "sourceLinks": [
      {
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/lucide-icons/lucide/releases/tag/1.27.0"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend build pipelines, monorepos, and CI jobs.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "Patch turbo 2.10.7 release detected with no OSV match.",
    "githubReleaseTitle": "",
    "githubReleaseUrl": "",
    "githubReleaseTag": "",
    "githubReleasePublishedAt": "",
  ...
  },
  {
    ...
    "publishedAgo": "published 257 days ago",
    "isRecent": false,
    "risk": "low",
    "category": "Patch version",
    "osv": "No OSV match",
...
export const packageRoutes = {
  ...
  "turbo": {
    ...
    "description": "Monorepo build system",
    "route": "/package/turbo",
    "latestReleaseRoute": "/package/turbo/2.10.7",
    "areaSlug": "build-tooling",
    "areaLabel": "Build Tooling"
  },
  "parcel": {
  ...
  "lucide-react": {
    ...
    "latestReleaseRoute": "/package/lucide-react/1.27.0",
    "areaSlug": "css-ui",
    "areaLabel": "CSS and UI Libraries"
  },
  "mui-material": {
...
export const seoRoutes: Record<string, SeoRoute> = {
  "/weekly": {
    ...
    "description": "Week 31, 2026 digest for frontend npm security updates, breaking package releases, OSV/CVE signals, React dependency risk, and recommended update actions from 82 tracked packages."
  },
  "/risk/security": {
    "path": "/risk/security",
  ...
  "/weekly/2026-w31": {
    ...
    "description": "Jul 20 - Jul 26 archive for frontend npm dependency risk: 24 risky updates, 3 breaking releases, 0 security updates, OSV/CVE checks, and recommended actions."
  },
  "/weekly/2026-w30": {
  ...
  "/package/lucide-react/1.27.0": {
    "path": "/package/lucide-react/1.27.0",
    "title": "lucide-react 1.27.0 npm minor version update",
    "description": "lucide-react 1.27.0 frontend npm update risk: Minor version release detected with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release..."
  },
  ...
  "/package/turbo/2.10.7": {
    "path": "/package/turbo/2.10.7",
    "title": "turbo 2.10.7 npm patch version update",
    "description": "turbo 2.10.7 frontend npm update risk: Patch release with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: No urgent action. Include in the next scheduled dependency update."
  },
