...
export const generatedAt = "2026-06-01T00:16:40.067Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-01T00:16:40.067Z"
  }
];
export const releases: ReleaseItem[] = [
  ...
  },
  {
    ...
    "whatChanged": "GitHub release note found: pnpm 11.5.",
    "githubReleaseTitle": "pnpm 11.5",
    "githubReleaseUrl": "https://github.com/pnpm/pnpm/releases/tag/v11.5.0",
    "githubReleaseTag": "v11.5.0",
    "githubReleasePublishedAt": "2026-05-29T15:51:39Z",
    "releaseNotesExcerpt": "Minor Changes Added a new hoistingLimits setting for nodeLinker: hoisted installs, mirroring yarn's nmHoistingLimits. It accepts none (the default - hoist as far as possible), workspaces (hoist only as far as each workspace package), or dependencies (hoist only up to each workspa",
    "releaseNotesStatus": "Matched GitHub release by npm version tag. Cached from an earlier generator run.",
    ...
    "sourceLinks": [
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/pnpm/pnpm/releases/tag/v11.5.0"
      }
    ]
  },
  {
    ...
    "recommendedAction": "Review changes before updating. Test in staging before merging. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: v4.1.7.",
    "githubReleaseTitle": "v4.1.7",
    "githubReleaseUrl": "https://github.com/vitest-dev/vitest/releases/tag/v4.1.7",
    "githubReleaseTag": "v4.1.7",
    "githubReleasePublishedAt": "2026-05-20T07:20:12Z",
    "releaseNotesExcerpt": "&nbsp;&nbsp;&nbsp; Bug Fixes **runner**: Limit concurrency per task branch in addition to per leaf callbacks (backport) &nbsp;-&nbsp; by @hi-ogawa in https://github.com/vitest-dev/vitest/issues/10384 <samp>(4f0f2)</samp> &nbsp;&nbsp;&nbsp;&nbsp;View changes on GitHub",
    "releaseNotesStatus": "Matched GitHub release by npm version tag. Cached from an earlier generator run.",
    ...
    "sourceLinks": [
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/vitest-dev/vitest/releases/tag/v4.1.7"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "oldVersion": "0.0.0-experimental-9635257c-20260502",
    "newVersion": "19.2.6",
    ...
    "recommendedAction": "Review changes before updating. Test in staging before merging. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: 19.2.6 (May 6th, 2026).",
    "githubReleaseTitle": "19.2.6 (May 6th, 2026)",
    "githubReleaseUrl": "https://github.com/facebook/react/releases/tag/v19.2.6",
    "githubReleaseTag": "v19.2.6",
    "githubReleasePublishedAt": "2026-05-06T16:27:45Z",
    "releaseNotesExcerpt": "React Server Components Type hardening and performance improvements (#36425 by @eps1lon and @unstubbable)",
    "releaseNotesStatus": "Matched GitHub release by npm version tag. Cached from an earlier generator run.",
  ...
  },
  {
    ...
    "githubReleaseUrl": "https://github.com/storybookjs/storybook/releases/tag/v10.4.1",
    "githubReleaseTag": "v10.4.1",
    "githubReleasePublishedAt": "2026-05-22T09:46:17Z",
    "releaseNotesExcerpt": "10.4.1 Angular: Detect model() signal outputs (type inference + compodoc autodocs + runtime binding) - #34833, thanks @valentinpalkovic! Build: Upgrade type-fest to latest version 5.6.0 - #34791, thanks @tobiasdiez! CLI: Run \\npx expo install --fix\\ after init for Expo projects -",
    "releaseNotesStatus": "Matched GitHub release by npm version tag. Cached from an earlier generator run.",
    ...
    "sourceLinks": [
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/storybookjs/storybook/releases/tag/v10.4.1"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend projects that import this package directly or receive it through transitive dependencies.",
    "recommendedAction": "Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review.",
    "whatChanged": "GitHub release note found: v16.3.0-canary.36.",
    "githubReleaseTitle": "v16.3.0-canary.36",
    "githubReleaseUrl": "https://github.com/vercel/next.js/releases/tag/v16.3.0-canary.36",
    "githubReleaseTag": "v16.3.0-canary.36",
    "githubReleasePublishedAt": "2026-05-31T00:00:36Z",
    "releaseNotesExcerpt": "Misc Changes Turbopack analyzer: analyze ternaries + promises in string & nullish methods: #94187 [turbopack] Break up graph.rs in the analyzer into smaller files: #94211 [turbopack] Add explain() methods to WellKnownObjectKind and WellKnownFunctionKind: #94217 [turbopack] Handle",
    ...
    "sourceLinks": [
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/vercel/next.js/releases/tag/v16.3.0-canary.36"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend build pipelines, monorepos, and CI jobs.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: v8.0.14.",
    "githubReleaseTitle": "v8.0.14",
    "githubReleaseUrl": "https://github.com/vitejs/vite/releases/tag/v8.0.14",
    "githubReleaseTag": "v8.0.14",
    "githubReleasePublishedAt": "2026-05-21T07:15:28Z",
    ...
    "sourceLinks": [
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/vitejs/vite/releases/tag/v8.0.14"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "affectedAudience": "Frontend build pipelines, monorepos, and CI jobs.",
    "recommendedAction": "No urgent action. Include in the next scheduled dependency update.",
    "whatChanged": "GitHub release note found: v4.60.4.",
    "githubReleaseTitle": "v4.60.4",
    "githubReleaseUrl": "https://github.com/rollup/rollup/releases/tag/v4.60.4",
    "githubReleaseTag": "v4.60.4",
    "githubReleasePublishedAt": "2026-05-14T17:54:35Z",
    "releaseNotesExcerpt": "4.60.4 _2026-05-14_ Bug Fixes Improve stability of chunk hashes (#6362) Pull Requests #6362: fix: stabilize chunk assignment across parallel file reads (@sonukapoor, @Sonu Kapoor, @TrickyPi, @lukastaegert) #6370: fix(deps): update minor/patch updates (@renovate[bot]) #6371: chore",
    "releaseNotesStatus": "Matched GitHub release by npm version tag. Cached from an earlier generator run.",
    ...
    "sourceLinks": [
      ...
      {
        "label": "GitHub release",
        "href": "https://github.com/rollup/rollup/releases/tag/v4.60.4"
      }
    ]
  },
  {
...
export const packageRoutes = {
  "react": {
    ...
    "description": "UI library",
    "route": "/package/react",
    "latestReleaseRoute": "/package/react/19.2.6"
  },
  "react-dom": {
    "packageName": "react-dom",
    "description": "React DOM rendering",
    "route": "/package/react-dom",
    "latestReleaseRoute": "/package/react-dom/19.2.6"
  },
  "next": {
    "packageName": "next",
    "description": "React framework",
    "route": "/package/next",
    "latestReleaseRoute": "/package/next/16.2.6"
  },
  "vite": {
    "packageName": "vite",
    "description": "Frontend build tooling",
    "route": "/package/vite",
    "latestReleaseRoute": "/package/vite/8.0.14"
  },
  "typescript": {
    "packageName": "typescript",
    "description": "Typed JavaScript compiler",
  ...
  "rollup": {
    ...
    "latestReleaseRoute": "/package/rollup/4.60.4"
  },
  "esbuild": {
    "packageName": "esbuild",
    "description": "JavaScript bundler",
  ...
  "vitest": {
    ...
    "latestReleaseRoute": "/package/vitest/4.1.7"
  },
  "jest": {
    "packageName": "jest",
    "description": "JavaScript testing",
  ...
  "storybook-react": {
    ...
    "latestReleaseRoute": "/package/storybook-react/10.4.1"
  },
  "storybook": {
    "packageName": "storybook",
    "description": "Component documentation",
    "route": "/package/storybook",
    "latestReleaseRoute": "/package/storybook/10.4.1"
  },
  "sass": {
    "packageName": "sass",
    "description": "CSS preprocessor",
...
export const seoRoutes: Record<string, SeoRoute> = {
  "/weekly": {
    ...
    "description": "24 risky updates, 7 breaking changes, and 3 security-relevant releases from 50 tracked frontend npm packages."
  },
  "/risk/security": {
    "path": "/risk/security",
  ...
  "/weekly/2026-w23": {
    ...
    "description": "May 25 - May 31: 24 risky updates, 7 breaking changes, and 3 security-relevant releases from 50 tracked frontend npm packages."
  },
  "/package/react": {
    "path": "/package/react",
  ...
  "/package/ws/8.21.0": {
    ...
    "description": "ws 8.21.0: GitHub release notes mention security or vulnerability fixes. Recommended action: Update recommended. Review the GitHub release notes and prioritize this package in the security lane."
  },
  "/package/axios/1.16.1": {
    "path": "/package/axios/1.16.1",
    "title": "axios 1.16.1 security update",
    "description": "axios 1.16.1: GitHub release notes mention security or vulnerability fixes. Recommended action: Update recommended. Review the GitHub release notes and prioritize this package in the security lane."
  },
  "/package/npm-run-all/4.1.5": {
    "path": "/package/npm-run-all/4.1.5",
    "title": "npm-run-all 4.1.5 security update",
    "description": "npm-run-all 4.1.5: GitHub release notes mention security or vulnerability fixes. Recommended action: Update recommended. Review the GitHub release notes and prioritize this package in the security lane."
  },
  "/package/pnpm/11.5.0": {
    "path": "/package/pnpm/11.5.0",
    "title": "pnpm 11.5.0 breaking update",
    "description": "pnpm 11.5.0: Major version release detected. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/vitest/4.1.7": {
    "path": "/package/vitest/4.1.7",
    "title": "vitest 4.1.7 breaking update",
    "description": "vitest 4.1.7: Major version release detected. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/styled-components/6.4.2": {
    "path": "/package/styled-components/6.4.2",
    "title": "styled-components 6.4.2 breaking update",
    "description": "styled-components 6.4.2: Major version release detected. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/tailwindcss/4.3.0": {
    "path": "/package/tailwindcss/4.3.0",
    "title": "tailwindcss 4.3.0 breaking update",
    "description": "tailwindcss 4.3.0: Major version release detected. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/react/19.2.6": {
    "path": "/package/react/19.2.6",
    "title": "react 19.2.6 breaking update",
    "description": "react 19.2.6: Major version release detected. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  "/package/react-dom/19.2.6": {
    "path": "/package/react-dom/19.2.6",
    "title": "react-dom 19.2.6 breaking update",
    "description": "react-dom 19.2.6: Major version release detected. Recommended action: Review changes before updating. Test in staging before merging. GitHub release notes were found for review."
  },
  ...
  "/package/react-hook-form/7.77.0": {
    ...
    "description": "react-hook-form 7.77.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/date-fns/4.4.0": {
    "path": "/package/date-fns/4.4.0",
    "title": "date-fns 4.4.0 review update",
    "description": "date-fns 4.4.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/react-router-dom/7.16.0": {
    "path": "/package/react-router-dom/7.16.0",
    "title": "react-router-dom 7.16.0 review update",
    "description": "react-router-dom 7.16.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/cypress/15.16.0": {
    "path": "/package/cypress/15.16.0",
    "title": "cypress 15.16.0 review update",
    "description": "cypress 15.16.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/storybook-react/10.4.1": {
    "path": "/package/storybook-react/10.4.1",
    "title": "@storybook/react 10.4.1 review update",
    "description": "@storybook/react 10.4.1: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/storybook/10.4.1": {
    "path": "/package/storybook/10.4.1",
    "title": "storybook 10.4.1 review update",
    "description": "storybook 10.4.1: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/sass/1.100.0": {
    "path": "/package/sass/1.100.0",
    "title": "sass 1.100.0 review update",
    "description": "sass 1.100.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  ...
  "/package/reduxjs-toolkit/2.12.0": {
    ...
    "description": "@reduxjs/toolkit 2.12.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/next/16.2.6": {
    "path": "/package/next/16.2.6",
    "title": "next 16.2.6 review update",
    "description": "next 16.2.6: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/zod/4.4.3": {
    "path": "/package/zod/4.4.3",
    "title": "zod 4.4.3 review update",
    "description": "zod 4.4.3: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/autoprefixer/10.5.0": {
    "path": "/package/autoprefixer/10.5.0",
    "title": "autoprefixer 10.5.0 review update",
    "description": "autoprefixer 10.5.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/esbuild/0.28.0": {
    "path": "/package/esbuild/0.28.0",
    "title": "esbuild 0.28.0 review update",
    "description": "esbuild 0.28.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
  "/package/emotion-react/11.14.0": {
    "path": "/package/emotion-react/11.14.0",
    "title": "@emotion/react 11.14.0 review update",
    "description": "@emotion/react 11.14.0: Minor version release detected with no OSV match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes were found for review."
  },
