...
export const generatedAt = "2026-06-18T22:47:44.820Z";
...
export const digestArchive: WeeklyDigest[] = [
  {
    ...
    "generatedAt": "2026-06-18T22:47:44.820Z"
  },
  {
    "week": "Week 24, 2026",
...
export const seoRoutes: Record<string, SeoRoute> = {
  ...
  "/weekly/2026-w25": {
    ...
    "description": "Jun 15 - Jun 21 archive for frontend npm dependency risk: 35 risky updates, 10 breaking releases, 4 security updates, OSV/CVE checks, and recommended actions."
  },
  "/weekly/2026-w24": {
  ...
  "/package/rollup/4.62.0": {
    ...
    "title": "rollup 4.62.0 npm review update",
    "description": "rollup 4.62.0 frontend npm update risk: Minor version release detected with no OSV match. OSV: No OSV match. CVE: No CVE match. Recommended action: Review if used. Batch with normal dependency maintenance. GitHub release notes..."
  },
